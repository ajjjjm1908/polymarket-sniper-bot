...
Fast-entry Polymarket template for newly active contracts, early mispricing capture, and automated exit logic once liquidity normalizes.

Monitors newly opened or fast-moving markets and reacts with tightly bounded risk and slippage settings.
...
ORDER_SIZE_USD=20
WATCH_TAGS=politics,crypto,breaking-news
```
...
2. Start the market watcher so the bot can monitor fresh listings, rapid volume expansion, and odds dislocations across new and high-volume Polymarket markets.
...
v. 0.1.25.2026-04-07T22:30:26.838Z
